...
bp = Blueprint('smsframework-yunpian', __name__, url_prefix='/')
...
def im():
    ...
    g.provider._receive_message(message)  # any exceptions will respond with 500, and Yunpian will happily retry later
